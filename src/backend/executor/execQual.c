...
TupleTableSlot *
ExecProjectBuffer(ProjectionInfo *projInfo, ExprDoneCond *isDone, unsigned int pos)
{
	TupleTableSlot *slot;
	ExprContext *econtext;
	int			numSimpleVars;
...
TupleTableSlot *
ExecProject(ProjectionInfo *projInfo, ExprDoneCond *isDone)//Taras: original - shall not change
{
	TupleTableSlot *slot;
	ExprContext *econtext;
	int			numSimpleVars;
